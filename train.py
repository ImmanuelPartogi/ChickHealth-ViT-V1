...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler=None, 
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_accuracy:
            ...
            if 'vit' in model_type:
                model_path = os.path.join(save_dir, 'best_vit_chicken_classifier.pth')
            else:
                model_path = os.path.join(save_dir, 'best_chicken_classifier.pth')
    ...
    if 'vit' in model_type:
        best_model_path = os.path.join(save_dir, 'best_vit_chicken_classifier.pth')
    else:
        best_model_path = os.path.join(save_dir, 'best_chicken_classifier.pth')
...
def main():
    ...
    if 'vit' in args.model_type:
        print(f"Best model saved to {os.path.join(args.output_dir, 'best_vit_chicken_classifier.pth')}")
    else:
        print(f"Best model saved to {os.path.join(args.output_dir, 'best_chicken_classifier.pth')}")
